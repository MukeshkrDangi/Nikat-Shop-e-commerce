...
public class MyOrderAdapter extends RecyclerView.Adapter<MyOrderAdapter.Viewholder> {
    ...
    class  Viewholder extends  RecyclerView.ViewHolder{
        ...
        public Viewholder(@NonNull View itemView) {
            ...
            productImage = itemView.findViewById(R.id.product_image_ord);
            productTitle = itemView.findViewById(R.id.product_title_ord);
        ...
        private void setData ( int resource, int rating, String title , String deliveredDate){
            ...
            if (deliveredDate.equals("Cancelled")) {
                orderIndicator.setImageTintList(ColorStateList.valueOf(itemView.getContext().getResources().getColor(R.color.primeryRed)));
