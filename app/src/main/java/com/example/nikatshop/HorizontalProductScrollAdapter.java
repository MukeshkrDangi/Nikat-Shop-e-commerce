            ...
            if (!title.equals("")) {
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent productDeatailsIntent = new Intent(itemView.getContext(), ProductDetailsActivity.class);
                        productDeatailsIntent.putExtra("PRODUCT_ID",productId);
                        itemView.getContext().startActivity(productDeatailsIntent);
                    }
                });
            }
        }
