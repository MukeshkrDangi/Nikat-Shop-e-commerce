...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public class HorizontalProductViewholder extends RecyclerView.ViewHolder {
        ...
        private void setHorizontalProductLayout(List<HorizontalProductScrollModel> horizontalProductScrollModelList, final String title, String color, List<WishlistModel> viewAllProductList) {
                ...
                if (!title.equals("")) {
                    ...
                    gridProductLayout.getChildAt(x).setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            productDetailsIntent.putExtra("PRODUCT_ID",horizontalProductScrollModelList.get(finalX).getProduct_ID());
