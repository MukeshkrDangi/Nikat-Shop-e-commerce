...
public class WishlistAdapter extends RecyclerView.Adapter<WishlistAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
       ...
       holder.setData(productId,resource,title,freeCoupen,rating,totalRatings,productPrice,cuttedPrice,paymentMethod,position,inStock);
    ...
    public class ViewHolder  extends  RecyclerView.ViewHolder{
        ...
        private  void setData(String productId,String resource, String title, long freeCoupensNo, String averageRate, long totalRatingsNo, String price, String cuttedPriceValue, boolean COD,int index,boolean inStock){
            ...
            if (inStock){
                ...
                productPrice.setTextColor(itemView.getContext().getResources().getColor(R.color.primeryRed));
